...
abstract class PopUpWindowUiBind<TFragmentLayout : ViewBinding> : PopUpWindow() {
    ...
    override fun onCreateView(
        ...
        ui = ViewBindingUtil.inflate(inflater, container, false, getViewBindingClass(javaClass))
        return ui?.root
    }
