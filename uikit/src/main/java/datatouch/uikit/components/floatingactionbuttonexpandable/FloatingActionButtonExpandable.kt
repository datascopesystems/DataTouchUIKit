package datatouch.uikit.components.floatingactionbuttonexpandable
...
class FloatingActionButtonExpandable @JvmOverloads constructor(
    ...
    companion object {
        ...
        private const val LEGACY_ANDROID_CARDVIEW_PADDING_FIX = 5
        private val TAG = FloatingActionButtonExpandable::class.java.name
    }

    private var expanded = false
    private val root: View = LayoutInflater.from(context)
        .inflate(R.layout.view_floating_action_button_expandable, this, true)
    ...
    private val cardElevation = resources.getDimensionPixelSize(R.dimen.card_elevation)
    ...
    init {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            cardView.setContentPadding(fabPadding, fabPadding, fabPadding, fabPadding)
        } else {
            cardView.setContentPadding(
                fabPadding,
                fabPadding,
                fabPadding,
                fabPadding - LEGACY_ANDROID_CARDVIEW_PADDING_FIX
            )
        }
    ...
    private fun calculateRadius() {
        cardView.viewTreeObserver.addOnGlobalLayoutListener(object :
            ...
            override fun onGlobalLayout() {
                ...
                // This kostyl is used because
                // old Android API returns different
                // height each time
                ...
                cardView.radius = ((actualHeight!! / 2) - 2 * cardElevation).toFloat()
            }
        })
    }
