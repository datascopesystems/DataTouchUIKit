...
import datatouch.uikit.components.dropdown.adapter.SelectableDropDownListAdapter

class TestSelectableDropDownListAdapter : SelectableDropDownListAdapter<TestItemHolder>() {
